...
//  MangoInteraction
//
//  Created by YangChang on 2018/12/4.
//  Copyright © 2018年 Changsha Zhiguan Information Technology Co.,Ltd. All rights reserved.
//
...
+ (UIButton *)ui_buttonSimple:(CGRect)rect font:(UIFont *)font normalColor:(UIColor *)normalColor normalText:(NSString *)normalText click:(void (^)(id x))click{
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
