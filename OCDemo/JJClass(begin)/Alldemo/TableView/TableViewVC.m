...
- (void)initTableView{
    ...
    SNJJWEAK
    //表格视图
    JJBaseTableView *jjTableView = [JJBaseTableView tableView:CGRectMake(0, 0, ScreenWidth,ScreenHeight - SafeAreaBottomHeight) style:UITableViewStylePlain registerDic:@{@"cell":@[@{@"class":@"JJTableViewCell"}],@"group":@[@{@"class":@"UITableViewHeaderFooterView"}]} headRefresh:^(JJBaseTableView *jjView,UITableView * _Nonnull tableView, NSMutableArray * _Nonnull datas) {
